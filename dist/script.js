class CitiesSlider extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("a", { href: "https://www.w3schools.com/html/" }, React.createElement("p", { className: "slider__slide-readmore" }, "read more"))),
...
const slides = [
{
  city: 'Nuuksio',
  country: 'Helsinki',
  img: 'https://retkipaikka.fi/wp-content/uploads/2019/02/suunnistus-nuuksio-tomi-pohja-1500x630.jpg' },

{
  city: 'Pallas-Yllästunturi',
  country: 'Lapland',
  img: 'https://www.haltia.com/assets/sivujen-kuvat/Retkelle-Suomen-luontoon/Maahisenkierros-MH-Sini-Veuro-4.png' }];
